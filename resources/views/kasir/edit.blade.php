                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Edit Data kasir</li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <form action="{{ route('kasir.update', $kasir->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body custom-padding"> <!-- Tambahkan kelas custom-padding di sini -->
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="nama_kasir" value="{{$kasir->nama_kasir}}" placeholder="Nama kasir">
                                        <p class="help-block">Masukkan Nama Anda </p>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label>Jenis Kelamin</label><br>
                                        <input type="radio" name="jenis_kelamin" value="Laki-Laki" {{ $kasir->jenis_kelamin == 'Laki-Laki' ? 'checked' : '' }}> Laki-Laki
                                        <input type="radio" name="jenis_kelamin" value="Perempuan" {{ $kasir->jenis_kelamin == 'Laki-Laki' ? 'checked' : '' }}> Perempuan
                                    </div>
                                    <div class="form-group mb-3">
                                        <label>Alamat</label>
                                        <textarea class="form-control" rows="3" placeholder="Masukkan Alamat" name="alamat">{{$kasir->alamat}}</textarea>
                                        <div class="form-group mb-3">
